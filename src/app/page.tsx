...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen bg-cyan-950">
      {/* Header */}
      <div className="w-full bg-cyan-900 border-b border-gray-700 p-4">
            ...
            >
              <div
                className={`px-4 py-2 rounded-2xl max-w-[80%] ${
                  msg.role === "ai"
                    ? "bg-slate-950 border border-gray-700 text-gray-100"
